...
public class Activitydrivinganalytics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Activitydrivinganalytics.this, ActivityHome.class);
        ...
        btnInsurance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Activitydrivinganalytics.this, ActivityInsuranceInfo.class);
                startActivity(intent);
            }
        });
    ...
    private void updateGPS() {
        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(Activitydrivinganalytics.this);
        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
    ...
    private void updateUIValues(Location location) {
        {
            ...
            Geocoder geocoder = new Geocoder(Activitydrivinganalytics.this);
            try {
